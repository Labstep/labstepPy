...
For guidance on generating an API key to connect to your Labstep account see `this article <https://help.labstep.com/en/articles/3636355-how-do-i-create-an-api-key-on-labstep>`_.
