...
from labstep.entities.experimentTemplate.model import ExperimentTemplate
import pytest
...
class TestExperimentTemplatePermissions:
    ...
    def test_create(self, admin, organization_with_users):
        ...
        helperMethods.testCreateAction(
            admin, users[0], org, ExperimentTemplate, entityParams)

    def test_edit_name(self, admin, organization_with_users):
        [org, users] = organization_with_users

        helperMethods.testEntityAction(admin, users[0], org, ExperimentTemplate,
    ...
    def test_inventory(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'edit', action)
    ...
    def test_unassign(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'assign', action_unassign)

    def test_lock(self, admin, organization_with_users):
        [org, users] = organization_with_users

        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'lock', lambda entity: entity.lock())
    ...
    def test_unlock(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'unlock', action_unlock)
    ...
    def test_comment(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'comment', action_comment)

    def test_delete(self, admin, organization_with_users):
        [org, users] = organization_with_users

        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'delete', lambda entity: entity.delete())
    ...
    def test_share(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'share', action_share)
    ...
    def test_tagging(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'tag:add_remove', action_tag)
    ...
    def test_collections(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'folder:add_remove', action_collection)
    ...
    def test_conditions(self, admin, organization_with_users):
        ...
        helperMethods.testEntityAction(
            admin, users[0], org, ExperimentTemplate, entityParams, 'edit', action_conditions)
 """
