...
from .constants import (commentEntityName, experimentEntityName,
                        protocolEntityName, resourceEntityName,
                        tagEntityName, workspaceEntityName)
...
def editExperiment(user, experiment, name=None, description=None,
    ...
    experiment = editEntity(user, experimentEntityName,
...
def editWorkspace(user, workspace, name=None, deleted_at=None):
    ...
    metadata = {'name': name,
                'deleted_at': deleted_at}
    workspace = editEntity(user, workspaceEntityName,
